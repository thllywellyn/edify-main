# Edify Online Education Platform (MERN Web App) [Website Link](https://edify.lsanalab.xyz)

## Project Description

Edify is a fully functional ed-tech platform that enables users to create, consume,
and rate educational content. The platform is built using the MERN stack, which includes
ReactJS, NodeJS, MongoDB, and ExpressJS.
Edify aims to provide:
...
In summary, Edify is a versatile and intuitive ed-tech platform that is designed to
...
The Edify ed-tech platform consists of three main components: the front end, the
...
Here is a high-level diagram that illustrates the architecture of the Edify ed-tech
platform:
...
The front end of Edify has all the necessary pages that an ed-tech platform should
...
Edify uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of Edify provides a range of features and functionalities, including:
...
1. Cloud-based media management: Edify uses Cloudinary, a cloud-based media
...
The back end of Edify uses a range of frameworks, libraries, and tools to ensure its
...
The back end of Edify uses a range of data models and database schemas to
...
Overall, the back-end of Edify is designed to provide a robust and scalable solution
...
The Edify platform's API is designed following the REST architectural style. The
...
In conclusion, the REST API design for the Edify ed-tech platform is a crucial part
